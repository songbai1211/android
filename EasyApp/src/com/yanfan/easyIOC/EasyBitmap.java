...
import com.yanfan.easyIOC.bitmap.Utils;
import com.yanfan.easyIOC.bitmap.core.BitmapCache;
import com.yanfan.easyIOC.bitmap.core.BitmapDisplayConfig;
import com.yanfan.easyIOC.bitmap.core.BitmapProcess;
import com.yanfan.easyIOC.bitmap.display.Displayer;
import com.yanfan.easyIOC.bitmap.display.SimpleDisplayer;
import com.yanfan.easyIOC.bitmap.download.Downloader;
import com.yanfan.easyIOC.bitmap.download.SimpleDownloader;
...
/**
 * 位图操作，由于自己写的不好，现在借用网络大神的位图功能
 */
public class EasyBitmap {
	private EasyBitmapConfig mConfig;
	...
	private static EasyBitmap mEasyBitmap;
	
	private EasyBitmap(Context context) {
		mContext = context;
		mConfig = new EasyBitmapConfig(context);
	 ...
	 * @return
	 */
	public static synchronized EasyBitmap create(Context ctx){
		if(mEasyBitmap == null){
			mEasyBitmap = new EasyBitmap(ctx.getApplicationContext());
		}
		return mEasyBitmap;
	}
	 ...
	 * @param bitmap
	 */
	public EasyBitmap configLoadingImage(Bitmap bitmap) {
	 ...
	 * @param bitmap
	 */
	public EasyBitmap configLoadingImage(int resId) {
	 ...
	 * @param bitmap
	 */
	public EasyBitmap configLoadfailImage(Bitmap bitmap) {
	 ...
	 * @param resId
	 */
	public EasyBitmap configLoadfailImage(int resId) {
	 ...
	 * @param bitmapHeight
	 */
	public EasyBitmap configBitmapMaxHeight(int bitmapHeight){
	 ...
	 * @param bitmapHeight
	 */
	public EasyBitmap configBitmapMaxWidth(int bitmapWidth){
	 ...
	 * @return
	 */
	public EasyBitmap configDownlader(Downloader downlader){
	 ...
	 * @return
	 */
	public EasyBitmap configDisplayer(Displayer displayer){
	 ...
	 * @return
	 */
	public EasyBitmap configDiskCachePath(String strPath){
	 ...
	 * @param size 缓存大小
	 */
	public EasyBitmap configMemoryCacheSize(int size){
	 ...
	 */
	public EasyBitmap configMemoryCachePercent(float percent){
	 ...
	 * @param size
	 */
	public EasyBitmap configDiskCacheSize(int size){
	 ...
	 * @param size
	 */
	public EasyBitmap configBitmapLoadThreadSize(int size){
		if(size >= 1)
	 ...
	 * @return
	 */
	public EasyBitmap configRecycleImmediately(boolean recycleImmediately){
    ...
    /**
     * 执行过此方法后,EasyBitmap的缓存已经失效,建议通过EasyBitmap.create()获取新的实例
     * @author fantouch
     */
	 ...
	 * @title 配置信息
	 */
	private class EasyBitmapConfig {
		public String cachePath;
		 ...
		 public EasyBitmapConfig(Context context) {
