...
import com.yanfan.easyIOC.EasyImageView;
...
public class GifDecoder extends Thread{
	...
	private EasyImageView action = null;
	
	
	private byte[] gifData = null;

	
	public GifDecoder(byte[] data,EasyImageView act){
		gifData = data;
		action = act;
	}
	
	public GifDecoder(InputStream is,EasyImageView act){
		in = is;
		action = act;
	}
